...
def cartaPlasticidad(Limite_liquido,Indice_plasticidad): #Definir la función
  ...
  point = np.array([Limite_liquido,Indice_plasticidad]) #Punto que marca tipo de suelo (con LL-IP)
