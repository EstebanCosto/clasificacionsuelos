...
def CartaPlasticidad(Limite_liquido1,Indice_plasticidad1): #Definir la función

  # Con los datos del limite liquido y el Indice de plasticidad se grafica la ubicación del suelo en la carta de plasticidad.
  plt.plot(Limite_liquido1,Indice_plasticidad1,'ro')
  plt.vlines(Limite_liquido1,0,60,'k','--')
  plt.annotate(' LL ',(Limite_liquido1,55))
  IP = Indice_plasticidad1 + 2
  plt.annotate(' IP ', (20, IP))
  plt.hlines(Indice_plasticidad1,0,100,'k','--')
  ...
  point = np.array([Limite_liquido1,Indice_plasticidad1]) #Punto que marca tipo de suelo (con LL-IP)
